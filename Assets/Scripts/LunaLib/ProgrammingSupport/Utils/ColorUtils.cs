...
namespace LunaLib {
    ...
    public static class ColorUtils {
        ...
        public static List<Color> ColorRamp(RemapedCurve hueCurve, RemapedCurve saturationCurve, RemapedCurve valueCurve, int shadeCount) {
            List<Color> result = new List<Color>();
            if (shadeCount == 1) {
                result.Add(Color.HSVToRGB(hueCurve.Evaluate(0.5f), saturationCurve.Evaluate(0.5f), valueCurve.Evaluate(0.5f)));
            }
        ...
        public static float Distance(Color a, Color b) => a.ToColorSystemVector(ColorSystem.RGBA).DistanceTo(b.ToColorSystemVector(ColorSystem.RGBA));
