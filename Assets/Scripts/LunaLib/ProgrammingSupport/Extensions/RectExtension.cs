...
namespace LunaLib {
    ...
    public static partial class RectExtension {
        ...
        public static float Area(this Rect rect) => Geometry.Quadrilateral.Area(rect.size);
        ...
        public static Vector2 LerpPoint(this Rect r, Vector2 point) => new(Mathf.Lerp(r.xMin, r.xMax, point.x), Mathf.Lerp(r.yMin, r.yMax, point.y));
        public static Vector2 InverseLerpPoint(this Rect r, Vector2 point) => new(Mathf.InverseLerp(r.xMin, r.xMax, point.x), Mathf.InverseLerp(r.yMin, r.yMax, point.y));
    ...
    public static partial class RectIntExtension {
        ...
        public static RectInt WithPosOffset(this RectInt rect, Vector2Int offset) {
        ...
        public static int Area(this RectInt rect) => Geometry.Quadrilateral.Area(rect.size);
        ...
        public static RectInt ClampedToBounds(this RectInt r, RectInt bounds) {
            r.ClampToBounds(bounds);
            return r;
        }
        ...
        public static RectInt BoundsIncluding(this RectInt r1, RectInt r2) => RectIntUtils.BoundsIncluding(r1, r2);
        public static bool IntersectsWith(this RectInt r1, RectInt r2) {
    ...
    public static partial class Rect3Extension {
        ...
        public static float Volume(this Rect3 rect) => Geometry.RectangularCuboid.Volume(rect.size);
    ...
    public static partial class Rect3IntExtension {
        ...
        public static int Volume(this Rect3Int rect) => Geometry.RectangularCuboid.Volume(rect.size);
